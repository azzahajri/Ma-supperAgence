 ...
 */
final class Version20221023160401 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        ADD city VARCHAR(255) NOT NULL, ADD address VARCHAR(255) NOT NULL, ADD postal_code VARCHAR(255) NOT NULL,
         ADD sold TINYINT(1) NOT NULL, ADD created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\'');
    }
